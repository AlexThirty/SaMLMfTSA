...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \textcolor{blue}{Capire se mettere implementazione o no}
	\end{itemize}
\end{frame}
...
\begin{frame}
	\begin{itemize}
		...
		\item The only parameter that is fine tuned is the 
	\end{itemize}
\end{frame}
...
\begin{frame}
	\begin{itemize}
		...
		\item The only parameter which is peculiar to the method and which gets selected with the same metrics is the outlier fraction.
	\end{itemize}
\end{frame}

\begin{frame}
	\textcolor{blue}{INSERIRE COMMENTI E RISULTATI +  EVENTUALE PARTE SU LSTM}
\end{frame}
